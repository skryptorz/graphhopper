...
public class MotorcycleFlagEncoderTest {
    ...
    private double getBendiness(EdgeIteratorState edge, double estimatedDistance) {
        ...
        IntsRef flags = encoder.handleWayTags(em.createEdgeFlags(), way, includeWay, 0l);
        edge.setFlags(flags);
        encoder.applyWayTags(way, edge);
        DecimalEncodedValue curvatureEnc = encoder.getDecimalEncodedValue("motorcycle.curvature");
