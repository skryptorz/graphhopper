...
public class FootFlagEncoderTest {
    ...
    public void testBasics() {
        ...
        assertEquals(footAccessEnc.getBool(false, ef1), footAccessEnc.getBool(false, ef2));
    ...
    public void testGraph() {
        ...
        g.edge(0, 2).setDistance(10).set(footAvSpeedEnc, 5.0).set(footAccessEnc, true).set(footAccessEnc, true);
        g.edge(1, 3).setDistance(10).set(footAvSpeedEnc, 10.0).set(footAccessEnc, true).set(footAccessEnc, true);
