...
public class DataFlagEncoder extends AbstractFlagEncoder {
    ...
    public void createEncodedValues(List<EncodedValue> registerNewEncodedValue, String prefix, int index) {
        ...
        registerNewEncodedValue.add(carMaxspeedEncoder = new DecimalEncodedValue(prefix + "car_maxspeed", speedBits, speedFactor, 0, true));
        ...
        registerNewEncodedValue.add(dynAccessEncoder = new IntEncodedValue(prefix + "car_dyn_access", 3, 1, false));
        ...
        // TODO NOW workaround to init AbstractWeighting.avSpeedEnc variable that GenericWeighting does not need
    ...
    public double getMaxspeed(EdgeIteratorState edge, int accessType, boolean reverse) {
        ...
        double val = carMaxspeedEncoder.getDecimal(reverse, edgeFlags);
        if (val < 0)
